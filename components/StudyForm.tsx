...
type StudyFormProps =
  ...
  | {
      ...
      // Lets a read-first parent view (StudyDetailView) return to its
...
export function StudyForm(props: StudyFormProps) {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      // NewStudyWizard, which owns the real create flow today); edit keeps
      ...
      if (isEdit) {
        ...
        router.push(`/admin/projects/${resultId}`);
      }
    } catch (err) {
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:items-start">
        ...
        <div className="flex flex-col gap-4">
          ...
          <label className="flex flex-col gap-1">
            ...
            <span className="text-xs text-muted-foreground">
              Shown to respondents on the study landing page. Keep it neutral and research-framed.
          ...
          <label className="flex flex-col gap-1">
            ...
            />
            <span className="text-xs text-muted-foreground">{`/study/${slug || "..."}`}</span>
        ...
        <div className="flex flex-col gap-3 rounded-control border border-border p-3">
          ...
          {showDetailsChat ? (
            <StudyOnboardingChat onComplete={handleDetailsGenerated} />
          ) : (
            <div className="flex flex-col gap-4">
              <label className="flex flex-col gap-1">
