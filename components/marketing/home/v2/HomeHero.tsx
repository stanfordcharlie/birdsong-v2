...
export function HomeHero({ bookDemoUrl }: { bookDemoUrl: string }) {
  return (
    <section
      id="top"
      className="hp-grid-ink relative mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-[16px] px-[24px] pb-[160px] pt-[110px] hp-wide:grid-cols-[minmax(150px,1fr)_minmax(0,3.6fr)_minmax(150px,1fr)]"
    >
      ...
      <div className="flex flex-col items-center gap-[28px] px-[8px] text-center">
