 ...
 *
 * Page-load intro (heroIntro.ts, app/globals.css `hp-i-*`). The `hp-i-*`
 * classes and the `--i-delay` / `--rot` properties are hooks for it and do
 * nothing unless the gate script has stamped <html data-intro="play">. The
 * H1 is split into two clipped line wrappers so each line can rise into
 * view; at and above 900px the wrappers are blocks, which is where the
 * balanced headline already broke, and below that they fall back to inline
 * so the phone wrap is untouched. The span around the "T" is the bird's
 * perch: inline, so it neither breaks the T–u kerning nor interrupts a
 * screen reader.
 */
const note =
  ...
  return (
    ...
    >
      ...
      <div className="relative hidden h-full min-h-[420px] hp-wide:block">
        <div className="hp-i-hand absolute left-0 top-0 rotate-[-8deg] whitespace-nowrap font-hp-hand text-[clamp(22px,2.6vw,36px)] font-semibold leading-none [--i-delay:1s]">
          ✓ Qualified
        </div>
        <div className={`${note} hp-i-note left-0 top-[44%] flex rotate-[-7deg] flex-col items-center justify-center gap-[2px] bg-hp-note-tan [--i-delay:.5s] [--rot:-7deg]`}>
        ...
        <div className={`${note} hp-i-note left-[clamp(40px,5vw,90px)] top-[72%] flex rotate-[5deg] flex-col justify-between px-[12%] pb-[10%] pt-[12%] bg-hp-note-yellow [--i-delay:.62s] [--rot:5deg]`}>
      ...
      <div className="relative flex flex-col items-center gap-[22px] px-[8px] text-center hp-wide:gap-[28px]">
        ...
        <h1 className="hp-i-h1 m-0 text-balance font-hp-serif text-[clamp(48px,6.6vw,96px)] font-normal leading-none tracking-[-0.025em]">
          <span className="hp-i-h1in">
            <span className="hp-i-line">
              <span className="hp-i-linein [--i-delay:.15s]">
                <span {...{ [PERCH_ATTR]: "" }}>T</span>urn Your Audience
              </span>
            </span>{" "}
            <span className="hp-i-line">
              <span className="hp-i-linein [--i-delay:.27s]">Into Pipeline.</span>
            </span>
          </span>
        </h1>
        <p className="hp-i-sub m-0 max-w-[640px] text-balance text-[clamp(18px,1.7vw,23px)] leading-[1.4] text-hp-body">
          Birdsong Agents Find The Right People, Talk To Them, And Route Qualified Opportunities
          Straight To Your Sales Team.
        </p>
        <div className="hp-i-ctas flex flex-wrap justify-center gap-[12px] pt-[8px]">
      ...
      <div className="relative hidden h-full min-h-[420px] hp-wide:block">
        <div className="hp-i-hand absolute right-0 top-0 rotate-[6deg] text-center font-hp-hand text-[clamp(22px,2.6vw,36px)] font-semibold leading-none [--i-delay:1.1s]">
          Demo
          <br />
          booked ✓
        </div>
        <div className={`${note} hp-i-note right-0 top-[40%] flex rotate-[7deg] items-center justify-center bg-hp-green shadow-hp-note-deep [--i-delay:.74s] [--rot:7deg]`}>
        ...
        <div className={`${note} hp-i-note right-[clamp(40px,5vw,90px)] top-[70%] flex rotate-[-5deg] flex-col items-center justify-center bg-hp-green-pale leading-none [--i-delay:.86s] [--rot:-5deg]`}>
