...
export function CtaBanner({ bookDemoUrl }: { bookDemoUrl: string }) {
  return (
    <section className="mx-auto max-w-[1200px] px-[24px] pb-[80px] hp-wide:pb-[120px]">
      <div className="hp-grid-cream relative flex flex-col items-center gap-[22px] overflow-hidden rounded-[8px] bg-hp-green px-[24px] py-[72px] text-center hp-wide:px-[32px] hp-wide:py-[110px]">
