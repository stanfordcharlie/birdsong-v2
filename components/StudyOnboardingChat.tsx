...
import { OPENING_MESSAGE } from "@/lib/study-onboarding/prompt";
import type { ExtractedSurveyDetails, SurveyOnboardingMessage } from "@/lib/study-onboarding/types";
import { renderWithBold } from "@/lib/chat/render-with-bold";

export function StudyOnboardingChat({
  onComplete,
}: {
  ...
  return (
    <div className="flex h-[min(56vh,560px)] min-h-[320px] flex-col overflow-hidden rounded-control border border-border">
      ...
      {/* Not a <form>: this whole chat renders inside StudyForm's own outer
