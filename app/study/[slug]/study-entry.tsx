...
//
//   /study/[slug]           the generic link (ads, Slack, SMS)
//   /study/[slug]/[token]   a prospect's personal link
//
...
export async function buildStudyMetadata(slug: string): Promise<Metadata> {
  const survey = await getStudy(slug);
...
export async function StudyEntry({
  slug,
  test,
