...
- People skim chat messages instead of reading every word, so wrap the core of the actual question in double asterisks for bold, a few words, enough that reading just the bolded words alone tells you what's being asked (e.g. "Is that full range still **accurate today**, or has it shifted?" or "Who's the actual **buyer signing off**, versus who uses it day to day?"). Not a single word, and not the whole sentence, one bolded phrase per message.
